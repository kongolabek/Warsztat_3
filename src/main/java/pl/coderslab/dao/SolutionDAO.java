...
public class SolutionDAO {
    ...
    public ArrayList<Solution> findAllByUserId(int usersId){
        try (Connection conn = DbUtil.getConnection()){
            ArrayList<Solution> solutionsList = new ArrayList<>();
            PreparedStatement statement = conn.prepareStatement(FIND_ALLBYUSER_SOLUTION_QUERY);
    ...
    public ArrayList<Solution> findAllByExerciseId(int exerciseId){
        try (Connection conn = DbUtil.getConnection()){
            ArrayList<Solution> solutionsList = new ArrayList<>();
            PreparedStatement statement = conn.prepareStatement(FIND_ALLBYEXERCISE_SOLUTION_QUERY);
